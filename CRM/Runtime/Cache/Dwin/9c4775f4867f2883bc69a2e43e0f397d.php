...
<div class="wrapper wrapper-content">
    <div class="ibox float-e-margins">
        <div class="ibox-content">
                <div class="title">
                        ...
                        <div>
                            ...
                            <button class="btn btn-xs btn-outline btn-success add_staff"><span class="glyphicon glyphicon-plus"></span>供应商添加</button>
                            <!-- <button class="btn btn-xs btn-outline btn-success edit_staff"><span class="glyphicon glyphicon-edit"></span>修改供应商</button> -->
                            <button class="btn btn-xs btn-outline btn-success audit_staff" @click="fun()"><span class="glyphicon glyphicon-adjust"></span>供应商审核</button>
                            <button class="btn btn-xs btn-outline btn-success details_staff" @click="fun()"><span class="glyphicon glyphicon-align-justify"></span>供应商信息详情</button>
        ...
        <div class="ibox-content" id="app">
            ...
            <!-- 二级级审核 -->
            <el-dialog title="选择审核的内容：" :visible.sync="dialogTableVisible" width="70%">
    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            approve(index,status,id,tips,file_id){
                ...
                if(status === '0'){
                    console.log(this.secondLevel[index])
        ...
        if (current_id === undefined){
            ...
            if (current_status == 2) {
                var index = layer.open({
                    type: 2,
                    title: '采购合同信息',
                    // content: '/Dwin/Purchase/getAddPurchaseContract?id=' + currentId,
