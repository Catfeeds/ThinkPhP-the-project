                ...
                <div class="ibox-content" >
                    ...
                    <div class="span-warning" id="buttonVm">
                        <form class="form-inline">
                            <!-- <el-button-group> -->
                                <el-button size='mini' class="suspend" icon="el-icon-refresh" @click="refreshAction()">刷新</el-button>
                                <el-button size='mini' class="suspend" icon="el-icon-d-arrow-right" @click="getPreStock()">下推</el-button>
                            <!-- </el-button-group> -->
                            <label for="production_line">&nbsp;班组筛选:</label>
                            <select name="" id="production_line" class="form-control change-data" style="padding: 5px 12px;font-size:13px;" size='mini'>
                            ...
                            <select name="" id="production_status" class="form-control change-dat" style="    font-size: 13px;font-size:13px;" size='mini'>
...
<script>
    ...
    $(document).ready(function() {
        ...
        "ajax"         :{ // 获取数据
            "url"   : "/Dwin/Production/productionTaskIndex",
            "type"  : 'post',
            "data"  : {
                "lineLimit" : function () {
        ...
        fnRowCallback:function(nRow,aData,iDisplayIndex,iDisplayIndexFull){
            var AD_as = nRow['children'][nRow['children'].length - 3]
            for(let key in nRow){
        ...
        planTBody.on("click", "tr", function () {
            ...
            $.post('/Dwin/Production/getRelationDataWithTaskId', {'productionTaskId': selectedID}, function (res) {
