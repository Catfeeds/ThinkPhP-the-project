...
<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.0.489/pdf_viewer.css" rel="stylesheet">
    <!-- This snippet is used in production (included from viewer.html) -->
    <link rel="resource" type="application/l10n" href="/Public/pdfjs/web/locale/locale.properties">
    <!--<script src="/Public/pdfjs/build/pdf.js"></script>-->
    <!--<script src="/Public/pdfjs/build/pdf.worker.js"></script>-->
    ...
    <script src="/Public/pdfjs/web/viewer.js"></script>
    <style>
        .hidden{
            display: none;
        }
...
<script type="text/javascript">
    ...
    // var DEFAULT_URL = '/Public/Upload/supplier/contract/2018-08-27/5b8373a847b80.pdf';
    function doProhibit()
    {
        if(window.Event)
