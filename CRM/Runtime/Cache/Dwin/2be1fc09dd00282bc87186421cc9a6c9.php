        ...
        methods: {
            ...
            delContact: function (index) {
                ...
                layer.confirm('确认删除?', function (aaa) {
                    $.post('<?php echo U("delContact");?>', {id: vm.contact[index].id}, function (res) {
                        if (res.status == 200) {
                            vm.getData();
                        }
                        layer.msg(res.msg)
            ...
            saveContact: function (index) {
                ...
                if (data.flag == 'add'){
                    ...
                    $.post('<?php echo U("addContact");?>', {data: data}, function (res) {
                        if (res.status == 200) {
                            vm.getData();
                        }
                        layer.msg(res.msg)
                ...
                if (data.flag == 'put'){
                    $.post('<?php echo U("putContact");?>', {data: vm.contact}, function (res) {
                        if (res.status == 200) {
                            vm.getData();
                        }
                        layer.msg(res.msg)
