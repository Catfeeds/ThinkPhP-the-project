                ...
                <div class="ibox-content p-xl">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table class="table invoice-table1">
                                ...
                                <tr> <th>客户名称：<?php echo ($data["cus_name"]); ?></th>
                                    <th>
                                        快递方式：
                                ...
                                <tr>
                                    <th>
                                        收货人：<?php echo ($data["receiver"]); ?><!--receiver-->
                                    </th>
                                    <th>收货人联系方式：<?php echo ($data["receiver_phone"]); ?></th><!--receiver_phone-->
                    ...
                    <table class="table invoice-table1">
                        ...
                        <tr style="text-align: left;">
                            ...
                            <th>付款方式：
                                <?php switch($data["invoice_type"]): case "1": ?>增票<?php break;?>
                                    <?php case "2": ?>普票<?php break;?>
                                    <?php case "3": ?>换货<?php break;?>
                                    <?php case "4": ?>营业税票<?php break;?>
                                    <?php case "5": ?>收据<?php break; endswitch;?>
                            </th>
                            <th>发票收件人：<?php echo ($data["invoice_contact"]); ?></th><!--invoice_contact invoice_phone-->
                    ...
                    <table class="table invoice-table1">
                        ...
                        <tr style="text-align: left;">
                            ...
                            <th>结算日期：<?php echo ($data["invoice_contact"]); ?></th><!--invoice_contact invoice_phone-->
                            <th>订单流程：<?php echo ($data["invoice_phone"]); ?></th>
                            <th>发票接收地址：<?php echo ($data["invoice_addr"]); ?></th>
                        </tr>
                        </thead>
                    </table>
