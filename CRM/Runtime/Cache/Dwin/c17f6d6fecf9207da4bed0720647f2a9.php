        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="">
                        <form action="<?php echo U('productionLine');?>" method="post" class="form-inline" id="add">
                            <h4>新增生产线</h4>
                            <div class="form-group">
                                <label class="">生产线</label>
                                <input type="text" class="form-control" name="production_line" placeholder="请输入新的生产线">
                            </div>
                            <button type="submit" class="btn btn-primary form-group">新增生产线</button>
                        </form>
                    </div>
                    <hr>
                            ...
                            <table id="table1" class="table table-striped table-bordered table-full-width" width="100%">
                                ...
                                <tbody>
                                    <?php if(is_array($data)): foreach($data as $key=>$i): ?><tr>
                                            <td><?php echo ($i["id"]); ?></td>
                                            <td><?php echo ($i["production_line"]); ?></td>
                                            <td>
