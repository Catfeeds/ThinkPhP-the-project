        ...
        <div class="ibox-content">
                <div class="title">
                        ...
                        <div>
                            ...
                            <button class="btn btn-xs btn-outline btn-success edit_staff"><span class="glyphicon glyphicon-edit"></span>编辑</button>
                            ...
                            <button class="btn btn-xs btn-outline btn-success affix_staff"><span class="glyphicon glyphicon-cloud-upload"></span>上传附件</button>
                            <!-- <button class="btn btn-xs btn-outline btn-success indent_staff"><span class="glyphicon glyphicon-log-out"></span>生成物料订单</button> -->
                            <button class="btn btn-xs btn-outline btn-success preview_staff"><span class="glyphicon glyphicon-log-out"></span>预览</button>
                            <button class="btn btn-xs btn-outline btn-success print_staff"><span class="glyphicon glyphicon-log-out"></span>打印</button>
                        </div>
                    </div>
