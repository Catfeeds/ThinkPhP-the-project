        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="">
                        <form action="<?php echo U('stockIoCate');?>" method="post" class="form-inline" id="add">
                            <h4>新增类别</h4>
                    ...
                    <div class=" row" style="margin-top: 15px;">
                        <div class="col-xs-6">
                            ...
                            <table id="table1" class="table table-striped table-bordered table-full-width" width="100%">
                                ...
                                <tbody>
                                    <?php if(is_array($inputCate)): foreach($inputCate as $key=>$i): ?><tr>
                                            <td><?php echo ($i["id"]); ?></td>
                        ...
                        <div class="col-xs-6">
                            ...
                            <table id="table2" class="table table-striped table-bordered table-full-width" width="100%">
                                ...
                                <tbody>
                                <?php if(is_array($outputCate)): foreach($outputCate as $key=>$i): ?><tr>
                                        <td><?php echo ($i["id"]); ?></td>
                                        <td><?php echo ($i["cate_name"]); ?></td>
                                        <td>
                                            <button class="btn btn-info edit" data-id="<?php echo ($i["id"]); ?>">编辑</button>
