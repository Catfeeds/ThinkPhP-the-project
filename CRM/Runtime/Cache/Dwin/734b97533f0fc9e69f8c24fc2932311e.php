...
<body>
    ...
    <div class="row">
        <div style="display: inline-block;width:100%;margin-top: 3px;margin-left: 10px">
            <button class="btn btn-xs btn-outline btn-success accuse_staff"  id="addSaleRepairing"><span class="glyphicon glyphicon-plus"></span>添加维修记录</button>
            <button class="btn btn-xs btn-outline btn-success accuse_staff" id="eidtDoubleRepaining"><span class="glyphicon glyphicon-edit"></span>售后单编辑</button>
            <button class="btn btn-xs btn-outline btn-success accuse_staff" id="eidtSaleRepairing"><span class="glyphicon glyphicon-lock"></span>修改维修人员</button>
            <button class="btn btn-xs btn-outline btn-success accuse_staff" id="dataExport"><span class="glyphicon glyphicon-align-left"></span>数据报表管理</button>
            <button class="btn btn-xs btn-outline btn-success accuse_staff" id="showRecord"><span class="glyphicon glyphicon-book"></span>显示最近业务审核</button>
        </div>
    </div>
...
console.log('8888888888',saleType)
    ...
    if ( $(this).hasClass('selected') ) {
        ...
        $.ajax({
            ...
            success :function(msg){
                ...
                if(msg == 1){
                    $("#auditBtn").html("");
                    $("#auditBtn").append('<button class="btn  btn-success3" id="auditbutton" style="background-color:#5BC0DE;" type="button">审核选中项</button>');
                    $("#shoufei").remove();
                    $("#auditBtn").after('<button class="btn  btn-success3" id="shoufei" style="background-color:#5BC0DE;float:left;margin-top: 10px;" type="button">确认是否维修</button>');
                }else if(msg == 2){
                    $("#shoufei").remove();
                    $("#auditBtn").html("");
                    $("#auditBtn").append('<button class="btn  btn-success3" id="auditbutton" style="background-color:#5BC0DE;" type="button">审核选中项</button>');
                    ...
                    $("#shoufei").remove();
                    $("#auditBtn").html("");
                    $("#auditBtn").append('<button class="btn  btn-success3" id="shoufei" style="background-color:#5BC0DE;float:left;margin-top: 10px;" type="button">确认是否维修</button>');
                }else{
                    $("#auditBtn").html("");
                    $("#shoufei").remove();
                }
...
$(document).on("click",'tbody .active', function () {
    ...
    layer.open({
        ...
        area: ['100%', '100%'],
        content: "/Dwin/SaleService/editSaleRepairing/sid/" + sid //iframe的url
    }); 
});  
...
// 编辑
$("#eidtDoubleRepaining").on('click', function () {
    layer.open({
        type: 2,
        shadeClose : true,
        end : function () {
        ...
        title: '添加维修记录',
        area: ['100%', '90%'],
        content: "/Dwin/SaleService/editSaleBaseMsg/id/"+ getEditId,  //iframe的url
    });
});
// 编辑维修人员
$("#eidtSaleRepairing").on('click', function () {
    layer.open({
        type: 2,
        shadeClose : true,
        end : function () {
        ...
        title: '编辑维修人员',
        area: ['100%', '90%'],
        content: "/Dwin/SaleService/editRepairpersonMsg/id/"+ getEditId,  //iframe的url 
    });
});
//数据报表生成
