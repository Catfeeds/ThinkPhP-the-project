...
<script>
    ...
    $("#cusNameForSearch").on('keyup', function () {
        ...
        if ((_name || _num) != "") {
            $.ajax({
                type : 'POST',
                url  : "/Dwin/OnlineService/showCustomer",
                data : {
                    cusName : _name,
                    cusNum  : _num
                },
                success : function (msg) {
                    ...
                    for(var i = 0; i < msg.length; i++) {
                        ...
                        trInner   += "<tr class='btnadd' data='"+cid[i]+"'><td>" + cname[i] + "</td><td>" + keyword[i] + "</td><td>" + uname[i] + "</td><td>" + addtime[i] + "</td><td>" + counts[i] +
                            "</td><td><a href='javascript:;'><img src='/Public/Admin/images/edtico.png'></a></tr>";
                    }
                    $("#listof").html('');
                    ...
                    $('.btnadd').on('click',function()
                    {
                        ...
                        layer.open({
                            ...
                            content: "/Dwin/OnlineService/showOnlineServiceHisList/cid/" + cid //iframe的url
                        });
                    });
                }
            });
